        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                ...
                <div class="form-group" style="max-width: 350px;">
                    <label class="premium-header d-flex align-items-center" style="cursor: pointer; border-radius: 12px; padding: 10px 15px;">
                    ...
                    <div class="d-flex mt-2">
                        <div class="form-check mr-3" style="width: auto;">
                            <input class="form-check-input" type="radio" name="is_admin" id="admin_yes" value="yes">
                            <label class="form-check-label" for="admin_yes">Yes</label>
                        </div>
                        <div class="form-check" style="width: auto;">
                            <input class="form-check-input" type="radio" name="is_admin" id="admin_no" value="no" checked>
